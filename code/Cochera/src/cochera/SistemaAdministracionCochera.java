...
public class SistemaAdministracionCochera {
	...
	public void altaContratoDebitoCBU(String dniCliente, String idCochera, String tamano, String periodo,
			String entidad, String cbu, String patente) {
		Cliente cliente = this.buscarCliente(dniCliente);
		Cochera cochera = this.buscarCochera(idCochera);
		Abono abono = this.buscarAbono(tamano, periodo);
	...
	public void altaContratoEfectivo(String dniCliente, String idCochera, String tamano, String periodo,
			String patente) {
		Cliente cliente = this.buscarCliente(dniCliente);
		Cochera cochera = this.buscarCochera(idCochera);
		Abono abono = this.buscarAbono(tamano, periodo);
	...
	public void altaContratoDebitoTarjetaCredito(String dniCliente, String idCochera, String tamano, String periodo,
			String patente, String entidad, String numero, Date fechaDeVencimiento) {
		Cliente cliente = this.buscarCliente(dniCliente);
		Cochera cochera = this.buscarCochera(idCochera);
		Abono abono = this.buscarAbono(tamano, periodo);
		...
		if (cliente != null && cochera != null && abono != null) {
			...
			if (auto != null) {
				Contrato con = buscarContratoPorClienteCochera(cliente, auto);
				if (con == null) {
					this.contratos.add(new DebitoTarjetaCredito(abono, cochera, auto, cliente, entidad, numero,
							fechaDeVencimiento));
				}
			}
		}
	...
	public void modificarContratoDebitoCBU(int idContrato, String dniCliente, String idCochera, String tamano,
			String periodo, String entidad, String cbu, String patente) {
		Cliente cliente = this.buscarCliente(dniCliente);
		Cochera cochera = this.buscarCochera(idCochera);
		Abono abono = this.buscarAbono(tamano, periodo);
	...
	public void modificarEfectivo(int idContrato, String dniCliente, String idCochera, String tamano, String periodo,
			String patente) {
		Cliente cliente = this.buscarCliente(dniCliente);
		Cochera cochera = this.buscarCochera(idCochera);
		Abono abono = this.buscarAbono(tamano, periodo);
	...
	public void modificarDebitoTarjetaCredito(int idContrato, String dniCliente, String idCochera, String tamano,
			String periodo, String patente, String entidad, String numero, Date fechaDeVencimiento) {
		Cliente cliente = this.buscarCliente(dniCliente);
		Cochera cochera = this.buscarCochera(idCochera);
		Abono abono = this.buscarAbono(tamano, periodo);
		Contrato contrato = this.buscarContratoPorNumero(idContrato);
	...
	public void modificarCheque(int idContrato, String dniCliente, String idCochera, String tamano, String periodo,
			String patente) {
		Cliente cliente = this.buscarCliente(dniCliente);
		Cochera cochera = this.buscarCochera(idCochera);
		Abono abono = this.buscarAbono(tamano, periodo);
	...
	private Contrato buscarContratoPorClienteCochera(Cliente cliente, Auto auto) {
		...
		while (it.hasNext()) {
			...
			if (contrato.getCliente().getDni().equals(cliente.getDni())
					&& contrato.getAuto().getPatente().equals(auto.getPatente()) && contrato.getEstaActivo()) {
				return contrato;
			}
		}
		return null;
	...
	private Contrato buscarContratoPorNumero(int nroContrato) {
		...
		while (it.hasNext()) {
			Contrato contrato = it.next();
			if (contrato.getNroContrato() == nroContrato && contrato.getEstaActivo()) {
				return contrato;
			}
		}
		return null;
	...
	private MedioDePago buscarMedioDePago(String tipo, String entidad) {
		...
		while (it.hasNext()) {
			...
			if (medioDePago.getTipo().equals(tipo) && medioDePago.getEntidad().equals(entidad)
	...
	private Cochera buscarCochera(String idCochera) {
		...
		while (it.hasNext()) {
			...
			if (cochera.getId().equals(idCochera) && !cochera.getEstaOcupada()) {
				return cochera;
			}
		}
	...
	private Abono buscarAbono(String tamano, String periodo) {
		...
		while (it.hasNext()) {
			Abono abono = it.next();
			if (abono.getTamano().equals(tamano) && abono.getPeriodo().equals(periodo) && abono.getEstado() == 1) {
				return abono;
			}
		}
	...
	public void cobrarContrato(int nroContrato, float monto){
		...
		if (con != null) {
			con.cobrarCuota(monto, "Pago de Cuota");
		}
	}
}
