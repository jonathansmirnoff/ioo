...
public class AltaClienteView extends JDialog {
	...
	public AltaClienteView(SistemaAdministracionCochera sist) {
		sistema = sist;
		setVisible(true);
		...
		gl_contentPanel
				.setHorizontalGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPanel.createSequentialGroup().addGap(151)
								.addComponent(
										lblAltaDeCliente)
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						sistema.crearCliente(textField.getText(), textField_1.getText(), textField_2.getText(),
